# 🚀 Exercício: **Funções JS 3**

Bem-vindo ao exercício sobre **Funções** com JavaScript! 🎉 Siga as instruções abaixo para completar o desafio e testar suas habilidades. 💪
...
```bash
git clone https://github.com/profrafamatos/09-exercicio-funcoes-js-3.git
```
